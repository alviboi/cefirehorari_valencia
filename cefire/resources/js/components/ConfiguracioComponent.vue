      ...
      <div>
        <div class="uk-card uk-card-secondary uk-card-hover uk-card-body">
          ...
          <label class="uk-form-label" for="form-stacked-text"
            >Introdueix la clau de netadmin del servidor LliureX</label
          >
          <div class="uk-margin">
            <input
              v-model="netadmin"
              class="uk-input"
              type="password"
              placeholder="Contrasenya netadmin"
            />
          </div>
          <label class="uk-form-label" for="form-stacked-text"
            >Introdueix la contrasenya</label
          >
          <div class="uk-margin">
            <input
              v-model="servidor"
        ...
        <div class="uk-card uk-card-default uk-card-hover uk-card-body">
          ...
          <div class="uk-margin">
            <div class="uk-form-controls uk-form-controls-text">
              <label
                ><input
                  v-model="fitxar_aparell"
                  @click="canvia_dades('aparell')"
                  class="uk-checkbox"
                  type="checkbox"
                />
        ...
        <div class="uk-card uk-card-default uk-card-hover uk-card-body">
          ...
          <div class="uk-margin">
            <div class="uk-form-controls uk-form-controls-text">
              <label
                ><input
                  v-model="habilita_registre"
                  @click="canvia_dades('registra')"
                  class="uk-checkbox"
                  type="checkbox"
                />
        ...
        <div class="uk-card uk-card-secondary uk-card-hover uk-card-body">
          ...
          <div class="uk-margin">
            <div class="uk-form-controls uk-form-controls-text">
              ...
              <div class="uk-margin">
                <input
                  v-model="max_compensacions"
                  class="uk-input"
                  type="number"
                  step="1"
                  placeholder="Número de compensacions"
                  min="0"
                  max="9"
                />
              </div>
              <div class="uk-margin">
                <button
                  @click="canvia_dades('max_compensacions')"
                  class="uk-button uk-button-primary"
                >
                  Actualitza
                </button>
        ...
        <div class="uk-card uk-card-secondary uk-card-hover uk-card-body">
          ...
          <div class="uk-margin">
            ...
            <p class="uk-text-right">
              <button
                @click.prevent="afegix_minuts_admin"
                class="uk-button uk-button-primary"
                type="button"
              >
                Afegix
